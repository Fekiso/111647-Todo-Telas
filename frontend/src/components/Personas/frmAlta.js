...
const RegistrarPersona = () => {
  ...
  const RegistrarPersona = (values) => {
    ...
    axios
      .post(
        `http://localhost:3080/api/personas`,
        {
    ...
    if (!blnErrorAxios) {
      if (registrarCliente === 200) {
        if (respuesta === "OK") {
          snackbarEstado(true, "Elpaciente se registro correctamente", "Correcto");
      ...
      >
        {({ values, handleChange, handleSubmit, touched }) => (
          <form>
            ...
            >
              <DialogTitle>
                <Typography variant="h6">Registrar persona</Typography>
              </DialogTitle>
              <DialogContent>
                <TextField
                  id="apellido"
              ...
              <DialogActions>
                ...
                <Button className="Aceptar" onClick={(e) => ConfirmarRegistro()}>
                  Aceptar
                </Button>
              </DialogActions>
            </Dialog>
            ...
            >
              ...
              <DialogContent>
                <DialogContentText id="alert-dialog-description">
                  ¿Realmente desea cancelar el registro del paciente? Los datos que han sido
                  cargados en el formulario se perderan.
                </DialogContentText>
              </DialogContent>
              <DialogActions>
                <Button
